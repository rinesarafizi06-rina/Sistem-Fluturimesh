...
.select-btn {
    padding: 8px 14px; background-color: #f44336;
...
.popup-toast {
    ...
    transform: translateX(-50%); background-color: #48b731;
    color: white; padding: 15px 25px; border-radius: 8px;
    box-shadow: 0 5px 15px rgba(0,0,0,0.3); font-weight: 500;
    font-size: 14px; z-index: 1000; opacity: 0; pointer-events: none;
    transition: opacity 0.5s ease, top 0.5s ease; text-align: center;
